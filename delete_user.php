...
<head>
    ...
    <title>Delete Voter - IAA ONLINE VOTING SYSTEM</title>
...
<main class="result-card">
    ...
    <h1><?= $message_type === 'success' ? 'Voter removed' : 'Unable to remove voter' ?></h1>
    <p><?= htmlspecialchars($message) ?></p>
    <a href="admin_dashboard.php?page=view_voters" class="btn btn-submit px-4"><i class="bi bi-arrow-left me-2"></i>Back to voters</a>
</main>
